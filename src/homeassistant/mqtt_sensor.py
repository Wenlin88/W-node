...
class mqtt_sensors_handler():
            ...
            if data['sensor_data_type'] in self.supported_sensor_data_types:
                ...
                if not data['mac'] in self.knonw_sensor_IDs:
                    ...
                    if data['sensor_data_type'] == 'RuuviTagRAWv1' or data['sensor_data_type'] == 'RuuviTagRAWv2':
                        ...
                        init_successful = self._init_ruuvitag_sensor(data,mqtt_client)
                ...
                mqtt_client.publish(state_topic, msg=json.dumps(data).encode(), qos=0, retain=False)
                time.sleep(1)
    ...
    def print_data_on_buffer(self):
        ...
        self.publish_buffer = []
        debug('Print done!')
    def _init_ruuvitag_sensor(self, data,mqtt_client):
